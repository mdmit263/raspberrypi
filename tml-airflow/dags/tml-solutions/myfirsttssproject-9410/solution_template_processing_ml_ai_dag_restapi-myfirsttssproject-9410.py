...
step1 = importlib.import_module("tml-solutions.myfirsttssproject-9410.tml_system_step_1_getparams_dag-myfirsttssproject-9410")
step2 = importlib.import_module("tml-solutions.myfirsttssproject-9410.tml_system_step_2_kafka_createtopic_dag-myfirsttssproject-9410")
step3 = importlib.import_module("tml-solutions.myfirsttssproject-9410.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-myfirsttssproject-9410")
step4 = importlib.import_module("tml-solutions.myfirsttssproject-9410.tml_system_step_4_kafka_preprocess_dag-myfirsttssproject-9410")
step5 = importlib.import_module("tml-solutions.myfirsttssproject-9410.tml_system_step_5_kafka_machine_learning_dag-myfirsttssproject-9410")
step6 = importlib.import_module("tml-solutions.myfirsttssproject-9410.tml_system_step_6_kafka_predictions_dag-myfirsttssproject-9410")
step7 = importlib.import_module("tml-solutions.myfirsttssproject-9410.tml_system_step_7_kafka_visualization_dag-myfirsttssproject-9410")
step8 = importlib.import_module("tml-solutions.myfirsttssproject-9410.tml_system_step_8_deploy_solution_to_docker_dag-myfirsttssproject-9410")
step9 = importlib.import_module("tml-solutions.myfirsttssproject-9410.tml_system_step_9_privategpt_qdrant_dag-myfirsttssproject-9410")
step10 = importlib.import_module("tml-solutions.myfirsttssproject-9410.tml_system_step_10_documentation_dag-myfirsttssproject-9410")


with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-myfirsttssproject-9410",
