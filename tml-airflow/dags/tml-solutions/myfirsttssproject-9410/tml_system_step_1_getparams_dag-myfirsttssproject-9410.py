...
default_args = {
 ...
 'solutionname': 'myfirsttssproject-9410',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_myfirsttssproject-9410", default_args=default_args, tags=["tml_system_step_1_getparams_dag_myfirsttssproject-9410"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
