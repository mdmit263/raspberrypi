...
step3 = importlib.import_module("tml-solutions.myfirsttssproject-9410.tml_read_gRPC_step_3_kafka_producetotopic_dag-myfirsttssproject-9410")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_grpc_dag-myfirsttssproject-9410",
